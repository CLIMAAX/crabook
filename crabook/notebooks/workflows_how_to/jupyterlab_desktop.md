...
3.  In the hamburger menu (☰) of the welcome window, open the **Manage Python environments** dialog:
    ...
    -   In the **Additional Python packages** field, put *all* of the following
        ...
        ```
        adlfs=2024.7.0 affine=2.4.0 aiohttp=3.9.5 bokeh=3.5.0 boto3=1.37.33 bottleneck=1.4.0 branca=0.8.1 cartopy=0.23.0 cdsapi=0.7.7 cfgrib=0.9.14.0 conda contextily=1.6.0 dask-labextension=7.0.0 dask=2024.7.0 distributed=2024.7.0 eccodes=2.36.0 eodag=3.8.0 eurostat=1.1.1 flask=2.3.3 flox=0.11.1 folium=0.19.5 gdal=3.9.1 geopandas=1.0.1 ipykernel=6.29.5 ipyleaflet=0.19.1 ipympl=0.9.4 ipython=8.30.0 ipywidgets=8.1.3 jenkspy=0.4.1 jupyter-resource-usage=1.1.1 jupyter-server-proxy=4.4.0 jupyterlab-git=0.51.0 jupyterlab-myst=2.4.2 jupyterlab=4.2.7 localtileserver=0.11.0 lxml=5.3.2 matplotlib=3.8.4 nbgitpuller=1.2.1 netcdf4=1.7.1 notebook=7.2.2 numba=0.60.0 numexpr=2.10.0 numpy=1.26.4 openpyxl=3.1.4 osmnx=1.9.3 pandas=2.2.2 pip planetary-computer=1.0.0 plotly=5.22.0 pooch=1.9.0 pydataverse=0.3.5 pyogrio=0.8.0 pyproj=3.6.1 pystac-client=0.9.0 pytest=9.0.2 python-kaleido=0.2.1 python=3.12 pyyaml=6.0.2 rasterio=1.3.10 rasterstats=0.19.0 regionmask=0.13.0 requests=2.32.3 rio-cogeo=5.3.3 rio-tiler=7.6.0 rioxarray=0.15.7 scikit-learn=1.5.1 scipy=1.15.2 seaborn=0.13.2 shapely=2.0.6 tqdm=4.67.1 usgs=0.3.6 werkzeug=3.1.3 xarray=2024.6.0 xclim=0.50.0 xlrd=2.0.1 zarr=2.18.2
        ```
...
6.  Launch a Python **Console** by clicking on the corresponding square in the **Launcher** tab.
    ...
    -   At the bottom, next to the `[ ]` is an input field.
        ...
        ```
        !pip install damagescanner==0.7 earthkit-geo==0.3.0 earthkit-meteo==0.4.1 earthkit-utils==0.3.0 gisco-geodata==0.1.3 paretoset==1.2.5 pylandtemp==0.0.1a1
        ````
